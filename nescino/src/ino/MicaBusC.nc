...
configuration MicaBusC {
  provides {
	...
	/* Including more 2 interruption to Arduino Mega */
    interface GpioInterrupt as Int4_Interrupt;
    interface GpioInterrupt as Int5_Interrupt;
...
implementation {
  ...
  Atm128GpioInterrupt2C.Atm128Interrupt->HplAtm128InterruptC.Int0;
  Int2_Interrupt=Atm128GpioInterrupt2C.Interrupt;

  components new Atm128GpioInterruptC() as Atm128GpioInterrupt3C;
  Atm128GpioInterrupt3C.Atm128Interrupt->HplAtm128InterruptC.Int1;
  Int3_Interrupt=Atm128GpioInterrupt3C.Interrupt;

  components new Atm128GpioInterruptC() as Atm128GpioInterrupt4C;
  Atm128GpioInterrupt4C.Atm128Interrupt->HplAtm128InterruptC.Int2;
  Int4_Interrupt=Atm128GpioInterrupt4C.Interrupt;

  components new Atm128GpioInterruptC() as Atm128GpioInterrupt5C;
  Atm128GpioInterrupt5C.Atm128Interrupt->HplAtm128InterruptC.Int3;
  Int5_Interrupt=Atm128GpioInterrupt5C.Interrupt;
