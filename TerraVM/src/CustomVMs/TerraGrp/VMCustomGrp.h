...
enum{
	...
	SENSOR_CTL_BIT = 6,
	REQ_SOURCE1 = 0,	// In custom is SENSOR_VM
	REQ_SOURCE2 = 1,	// In custom is SENSOR_AGG						
	REQ_SOURCE3 = 2,	// In custom is SENSOR_LOCAL_AGG
	REQ_SOURCE4 = 3,	// In custom is SENSOR_VOTE
