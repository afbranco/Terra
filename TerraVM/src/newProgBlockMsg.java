 ...
 * This class implements a Java interface to the 'newProgBlockMsg'
 * message type.
 */
...
public class newProgBlockMsg extends net.tinyos.message.Message {
    ...
    /** Create a new newProgBlockMsg of the given data_length. */
    public newProgBlockMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new newProgBlockMsg with the given data_length
     * and base offset.
     */
    public newProgBlockMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new newProgBlockMsg using the given byte array
     * as backing store.
     */
    public newProgBlockMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public newProgBlockMsg(byte[] data, int base_offset) {
     ...
     */
    public newProgBlockMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new newProgBlockMsg embedded in the given message
     * at the given base offset.
     */
    public newProgBlockMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public newProgBlockMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
